...
import pickle
with open("xiaoming_dataset_xy_full.pickle", 'rb') as handle:
...
def get_model(input_shape=(100,50,3)):
    model2 = Sequential()
    model2.add(Conv2D(16,(2,2),strides=(1,1), data_format="channels_first",padding = 'same', input_shape=input_shape))
    model2.add(Activation('relu'))
    model2.add(MaxPooling2D(pool_size=(2, 2), data_format="channels_first",padding = 'same'))
    model2.add(Conv2D(64,(2,2),strides=(1,1), data_format="channels_first",padding = 'same'))
    model2.add(Activation('relu'))
    model2.add(MaxPooling2D(pool_size=(2, 2), data_format="channels_first",padding = 'same'))
    model2.add(Conv2D(128,(2,2),strides=(1,1), data_format="channels_first",padding = 'same'))
    model2.add(Activation('relu'))
    model2.add(Flatten())
